  define(["three", "jquery", "json!germany_normalized.json", "json!world.json", "mouseevents"], function(THREE, $, GERMANY, WORLD) {
 //New scene and camera
    ...
    var germanyData = GERMANY;
    drawThreeGeo(germanyData, 10, 'sphere', {
        color: 'red'
    });
